...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"> <img src="{{ asset('admin/image/' .$admin->image) }}" width="85" height="80" class="rounded-circle center"><br> {{$admin->name}}</div>
            <div class="list-group list-group-flush my-3">
                <a href="{{route('admins.dashboard')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a>
